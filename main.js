...
recognition.onresult = function (event){
    ...
    //cambie la  "C" de circle a minuscula para que coincida con la variable
    if(content == "circle")
      {
      ...
      //cambie la  "R" de rectangle a minuscula para que coincida con la variable
      ...
      function draw(){
         if(draw_circle == "set")
         {
          ...
          if(draw_rect == "set")
         {
          // esta linea sobraba por que el rectangulo no necesita radio
           rect(x,y,70,50);
      ...
      // todos los random estaban escritos como ramdom